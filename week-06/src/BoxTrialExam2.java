...
public class BoxTrialExam2 {
  public static void main(String[] args) {
    System.out.println("The surface of this cuboid is: " + getSurface(5, 6, 15));
    System.out.println("The volume of this cuboid is: " + getVolume(5, 6, 15));
