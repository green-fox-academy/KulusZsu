...
public class Main {
  public static void main(String[] args) {
    ...
    // THE POKEMON.JAVA BOOLEAN WILL EXAMINE THE POKEMONS' ARRAY LIST, IF THERE IS EQUALITY IN TYPE,
    // THE BOOLEAN WILL TRUE!!! --> THAT IS WHY WE HAVE TO EXAMINE WITH AN FOR/IF LOOP THE ELEMENTS IN
    // THE ARRAY LIST WITH pokemonOfAsh.
